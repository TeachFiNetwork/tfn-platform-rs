...
pub static ERROR_DIGITAL_IDENTITY_ALREADY_SET: &[u8] = b"digital identity address already set";
...
pub static ERROR_NO_IDENTITY: &[u8] = b"subscriber identity not provided";
